<?php
include("seguser.php");
if (isset($_GET['tipoempresa'])) $tipoempresa = $_GET['tipoempresa'];
   
if (isset($_GET['tipo'])) {
    $tipo = $_GET['tipo'];
    $enderecobase="atualizausuarioempresa.php";
    $requersenha="";
}

else {
    $tipo = "";
    $enderecobase="cadusuarioempresa.php";
...
<body class="app sidebar-mini">
    ...
    $sql = "SELECT razaosocial from empresa where idempresa=:idempresa";
    ...
    if ($tipo != "") {
        ...
        $action_form = "atualizausuarioempresa.php?tipo=$tipo";
        $cabecalho ="Edição Usuário - ".$nomeempresa;
    } else {
        for ($a = 0; $a < 30; $a++) {
            $campo[$a] = "";
        }
        ...
        $action_form = "cadusuarioempresa.php";
        $cabecalho ="Cadastrar Usuário - ".$nomeempresa;
    }
    ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-2 col-md-2">
                                                    ...
                                                    <option value="EMPRESA" <?php if($campo[7]=="EMPRESA") echo "SELECTED"?>>EMPRESA</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="hidden" value="<?php echo $tipoempresa?>" name="idempresa">
                                            <div class="form-group row">
                                                <div class="col-sm-2 col-md-2">

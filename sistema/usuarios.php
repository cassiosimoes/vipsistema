				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-3 col-sm-2">
							<div class="title">
								<h4>Relação de Usuários Cadastrados</h4>
							</div>
					  </div>
            <div class="col-md-2 col-sm-2">
              <?php if($tipouser=="GRUPO") echo  '<a href="cadastrarusuario.php" class="btn btn-primary">Novo Assistente</a>';
                        ?>
            </div>
            <div class="col-md-3 col-sm-2">

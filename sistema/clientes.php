...
function CriaRequest() {
 ...
 function enviarStatus(x) {
     ...
     xmlreq.open("GET", "listcliente.php?valor="+valor, true);
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-3 col-sm-2">
							<div class="title">
								<h4>Relação de Clientes Cadastrados</h4>
							</div>
					  </div>
            <div class="col-md-2 col-sm-2">
                            <a href="cadastrocliente.php" class="btn btn-primary">Novo Clientes</a>
                        </div>
            <div class="col-md-3 col-sm-2">

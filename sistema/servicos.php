...
function CriaRequest() {
 ...
 function enviarStatus(x) {
     ...
     xmlreq.open("GET", "listusuario.php?valor="+valor, true);
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-3 col-sm-2">
							<div class="title">
								<h4>Relação de Serviços : <?php echo $nomeempresa ?></h4>
							</div>
					  </div>
            <div class="col-md-2 col-sm-2">
              <?php if (isset($codigoempresa)) {
              ?>
              <a href="cadastrarservico.php?dados=<?php echo $codigoempresa;?>" class="btn btn-primary">Novo Serviço</a>
              <?php
              }
              ?>
